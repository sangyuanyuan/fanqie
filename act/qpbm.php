	...
	<div id=bodys>
		<div id=activity_body>
			...
			<div id=activitycontent>
				...
				<table align="center">
					<tr>
						<td></td><td><input id="activities_id" name="activities_id" type="hidden" value="1"></td>
					</tr>
					<tr>
						<td>姓名：</td>
					...
					<tr><td></td><td><button OnClick="signuppost()">提　交</button></td><td  align="center"><a href="list.php?id=1">查看报名情况</a></td></tr>
					<tr></tr>
				</table>
				</form>
			</div>
