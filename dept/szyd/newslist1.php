...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','971','height','64','src','nav','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','nav' ); //end AC code
    ...
    <div class="submain">
    	<div class="sub_l">
        <div class="btn"><a href="newslist1.php?id=<?php echo dept_category_id_by_name('温馨一隅','上海文广数字移动传播有限公司','news');?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image1','','pic2/btn_jx_on_03.jpg',1)"><img src="pic2/btn_jx_03.jpg" name="Image1" width="134" height="28" border="0" id="Image1" /></a></div>
        <div class="btn1"><a href="newslist1.php?id=<?php echo dept_category_id_by_name('分享家园','上海文广数字移动传播有限公司','news');?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','pic2/btn_jx_on_06.jpg',1)"><img src="pic2/btn_jx_06.jpg" name="Image2" width="134" height="28" border="0" id="Image2" /></a></div>
        <div class="btn1"><a href="newslist1.php?id=<?php echo dept_category_id_by_name('学无止境','上海文广数字移动传播有限公司','news');?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','pic2/btn_jx_on_08.jpg'',1)"><img src="pic2/btn_jx_08.jpg" name="Image3" width="134" height="28" border="0" id="Image3" /></a></div>
        <div class="btn1"><a href="newslist1.php?id=<?php echo dept_category_id_by_name('实用下载','上海文广数字移动传播有限公司','news');?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','pic2/btn_jx_on_10.jpg'',1)"><img src="pic2/btn_jx_10.jpg" name="Image4" width="134" height="28" border="0" id="Image4" /></a></div>
       </div>
        <div class="sub_right">
