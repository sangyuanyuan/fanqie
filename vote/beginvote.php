			...
			<div id=content>
				...
				<div id=question>
					...
					<div id=top>
						...
						能选几项：<input type="text"  name="vote[max_item_count]" value="1" class="required number" style="width:250px; border:1px solid #000000;">(1为单选,2以上为多选)<br>
						姓&nbsp&nbsp&nbsp&nbsp名：<input type="text"  name="vote[publisher]" value="<?php echo $_COOKIE['smg_user_nickname'];?>" class="required number" style="width:250px; border:1px solid #000000;">
