...
<? 
	...
	$news=$db->paginate('SELECT * FROM smg_shop where shopdpid='.$_REQUEST['id'].' order by createtime desc',16);
	...
	<div id=fqtglistcount style="padding-top:10px;">
		...
		<div class=context>
			<div class=cl>
				...
				<a href="/shop/spinfo.php?id=<? echo $news[$i]->id;?>"><? echo $news[$i]->title;?></a>
			</div>		
		</div>
		<? }}?>
