...
<div id=bodys>
 	<div id=baby>
 		...
 		<div class=pic2><img border=0 width=450 src="<? echo $babyshow1[0]->photourl;?>" /><div class=nd> <? echo $babyshow1[0]->babyname.'<br>'.$babyshow1[0]->content;?></div><div class="nd"><?php if($babyshow1[0]->parent_id==$_COOKIE['smg_username']){ ?><a href="babysignup.php?id=<?php echo $_REQUEST['id']; ?>">编辑</a><?php } ?></div></div>
