...
<div id=ibody>
	 ...
	 <div id=ibody_left>
		...
		<div id=ibody_right>
			...
			<div class=r_b>
			<?php
				$sql="select t1.* from smg_image t1 join smg_category t2 on t1.category_id=t2.id where t1.is_adopt=1 and t1.publisher is not null and t2.platform='show' order by t1.priority asc,t1.created_at desc";
