...
<div id=ibody>
	<div class="l">
    		<div id="title"></div>
     	  <div id="menu">
     	  	<div id=date style="margin-top:0px;">礼品商店</div>
     	  </div>        
        <div id="context">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" id="cs" width="640" height="600" align="middle">
				<param name="allowScriptAccess" value="sameDomain" />
			   	<param name="wmode" value="opaque"> 
				<param name="movie" value="cs.swf" />
				<param name="quality" value="high" />
				<param name="bgcolor" value="#ffcccc" />
				<embed src="cs.swf" quality="high" bgcolor="#ffcccc" width="640" height="520" LiveConnect=true id="cs" name="cs" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
			</object>
        </div>
