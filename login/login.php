	...
	<div id=main>
		<div id=login  style="background:none">
			...
			<div id=box style="border:1px solid #0066FF">
				...
				<div id=btn><input type="checkbox" id=nickname >昵称　　<a href="register.php" style="color:#000000; text-decoration:none">注册</a>　　<input type="button" value="登录" onClick="Admin_Login()" class="botton"></div>	
