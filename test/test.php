...
MiniSite.Weather = {
        ...
        _print: function(province, city, conainter)
        {
                ...
                MiniSite.JsLoader.load("http://weather.news.qq.com/inc/minisite_%22+_city_+%22.js", function()
                {
                        try
                        {
                                MiniSite.$(conainter).innerHTML =  city+ __minisite__weather__;
                        }
                        catch (e)
                        {
                        }
...
<script type="text/javascript" src="css/wealth.js"></script>
