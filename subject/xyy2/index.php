	...
	<div id=icenter>
		...
		<div id=bottom>
			<?php $news=$db->query('select id,title from smg_news where category_id=165 and is_adopt=1 order by priority asc,created_at desc limit 5');
				...
				{
			 ?>
				<div class=cl><span style="color:red;">·</span><a target="_blank" href="/news/news/news.php?id=<?php echo $news[$i]->id; ?>"><?php echo get_fck_content($news[$i]->title); ?></a><img src="/images/pic/new.gif"></div>
			<?php } ?>
		</div>
	</div>
	<div id=iright>
