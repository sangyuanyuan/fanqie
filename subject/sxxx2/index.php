	...
	<div id=i_m2>
		<div id=c_l>
			...
			<div id=q_l>
			 ...
			 ?>
					<div class=answer><span style="font-weight:bold;"><?php echo $answer[$i]->publisher; ?></span>:<a target="_blank" href="/fqzd/index.php?id=<?php echo $qa[0]->id; ?>"><?php echo mb_substr(delhtml($answer[$i]->content),0,30,"utf-8").'……'; ?></a></div>
				<?php } ?>
			</div>
			<div id=q_r>
