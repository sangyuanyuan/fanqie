<?php
	...
	$id = $_REQUEST['id'];
	$l_sql = 'select t1.title,t1.id,t1.created_at,t3.name from smg_video t1 join smg_subject_items t2 on t1.id=t2.resource_id join smg_subject_category t3 on t2.category_id=t3.id where t2.category_id='.$id.' and t1.is_adopt=1 order by t1.priority asc,t1.created_at desc';
	$l_title = 'title';
	$link = '/show/video.php?id=';
?>
