...
<?
	...
	$count=$db->query('select count(*) as num from smg_question_record where r_type="yx"');
?>
...
<div style="width:450px; margin-left:200px;line-height:20px; margin-top:30px; margin-bottom:10px; padding:10px; float:left; display:inline">
	<span style="color:red; font-size:16px; font-weight:bold;">元宵排行榜：</span><br>
	<? 
		$person=$db->paginate('select * from smg_question_record where r_type="yx" order by point desc,created_at desc',20);
