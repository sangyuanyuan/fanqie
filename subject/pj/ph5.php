...
<?
  $id=$_REQUEST['id'];
  $sql1=' and (created_at >="2009-05-01 00:00:00" and created_at<="2009-05-31 23:59:59" )';
...
order by b.allcounts desc) tb order by a1 desc) s';
		...
		$sql11=' and (n.created_at >="2009-05-01 00:00:00" and n.created_at<="2009-05-31 23:59:59" )';
...
<div style="width:450px; margin-left:200px;line-height:20px; margin-top:30px; margin-bottom:10px; padding:10px; float:left; display:inline">
	<? if($id==1){ ?><span style="width:450px; font-size:20px; font-weight:bold; text-align:center; line-height:25px; float:left;">五月发稿量排行榜</span><br><br><span style="color:red; font-size:16px; font-weight:bold;">排行榜：</span><br><? } else{?>
	<span style="width:450px; font-size:20px; font-weight:bold; text-align:center; line-height:25px; float:left;">五月点击量排行榜</span><br><br><span style="color:red; font-size:16px; font-weight:bold;">排行榜：</span><br>
	<? }?>
	<? if($id==1){ 
