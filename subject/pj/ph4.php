...
<?
  $id=$_REQUEST['id'];
  $sql1=' and (created_at >="2009-04-01 00:00:00" and created_at<="2009-04-30 23:59:59" )';
...
order by b.allcounts desc) tb order by a1 desc) s';
		...
		$sql11=' and (n.created_at >="2009-04-01 00:00:00" and n.created_at<="2009-04-30 23:59:59" )';
