...
<div style="width:450px; margin-left:200px;line-height:20px; margin-top:30px; margin-bottom:10px; padding:10px; float:left; display:inline">
	<? if($id==1){ ?><span style="width:450px; font-size:20px; font-weight:bold; text-align:center; line-height:25px; float:left;">六月发稿量排行榜</span><br><br><span style="color:red; font-size:16px; font-weight:bold;">排行榜：</span><br><? } else{?>
	<span style="width:450px; font-size:20px; font-weight:bold; text-align:center; line-height:25px; float:left;">六月点击量排行榜</span><br><br><span style="color:red; font-size:16px; font-weight:bold;">排行榜：</span><br>
	<? }?>
	<? if($id==1){ 
