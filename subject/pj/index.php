...
<? 
		...
		$sql11=' and (n.created_at >="2009-01-01 00:00:00" and n.created_at<="2009-03-31 23:59:59" )';
		$sql12=' and (n.created_at >="2009-01-01 00:00:00" and n.created_at<="2009-03-31 23:59:59" )';
		$newslist = $db->query('select * from smg_comment where resource_type="pj" order by created_at desc');
		$strsql="select a.*,sum(countnum) as num from (select d.name,sum(n.click_count) as countnum from smg_dept d left join smg_news n on d.id=n.dept_id and is_recommend=1 ".$sql11." group by n.dept_id union select d.name,sum(n.click_count) as countnum from smg_dept d left join smg_video n on d.id=n.dept_id and is_recommend=1 ".$sql12." group by n.dept_id) as a group by name order by num desc";
					...
					<TR>
                      <TD width="50%">
                        ...
                        <TABLE width="100%" border=0>
                          <TBODY>
                          <TR>
                            <TD colspan=2 class=STYLE3 width="50%" valign="top">
                            	<img src="smallperson.jpg">
                              </TD>
                            </TR>
                          </TBODY></TABLE></TD>
		              ...
		              <TR valign="top">
		                <td>
		                	<table >
								...
								<? }?>
								<tr><td colspan=2 align="right"><a target="_blank" href="ph.php?id=1">更多</a></td></tr>
							</table>
						</td>
						<td>
							<table >
								...
								<? }?>
								<tr><td colspan=2 align="right"><a target="_blank" href="ph.php?id=2">更多</a></td></tr>
							</table>
						</td>
					  </TR>
