...
<body>
	<div id=bodys>
		...
		<div id=ibody>
			...
			<div class=sub style="margin-top:10px; font-size:16px; color:#000000; line-height:20px;">作为SMG宝宝秀第二季，本季主题为“爸爸妈妈的宝宝”，即选拔与爸爸妈妈长的最像的可爱宝宝。同时，为了表达番茄网对SMG宝宝的祝福，凡是参加宝宝秀的宝宝们均会收到番茄网的儿童节礼物。欢迎广大网友踊跃参与。</div>
