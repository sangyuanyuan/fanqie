		...
		<?php include('inc/top.inc.php');?>
			<div id=qyh_index>
				...
				<div class=index_b_l>
					...
					<?php  $news=$db->query('select photo_scr,video_photo_src,id,description,title from smg_news where category_id=201 and is_adopt=1 order by priority asc,created_at desc limit 7');?>	
						<div class=content_l>
