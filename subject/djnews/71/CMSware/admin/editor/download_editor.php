...
function InputPicker(action, form, element)
{
	...
	switch(action) {
		...
		case 'upload_attach':
			...
			if(returnValue != null && returnValue['url'] != null) {
...
<table   border=0 width=100%   cellPadding=3 cellSpacing=0 >
 ...
 <tr class='tablelist'> 
              ...
              <td valign='middle'>
			<input name='data_SoftName' type='text' value="<?=$pInfo[SoftName]?>" size=90%  >
				</td>
				</tr>
 ...
 <tr class='tablelist'> 
              ...
              <td valign='middle'>
<input name='data_SoftType' size=20 type='text' value="<?=$pInfo[SoftType]?>"   >
        ...
        <option value="免费软件">免费软件</option>
          ...
          <option value="开源软件">开源软件</option>
			...
			<tr class='tablelist'> 
              ...
              <td valign='middle'><input name='data_SoftSize' type='text' value="<?=$pInfo[SoftSize]?>" size=20> </td> </tr> 
			  <tr class='tablelist'> 
              <td align=right  width=70>界面预览:</td>
              <td valign='middle'><input name='data_Photo' type='text' value="<?=$pInfo[Photo]?>" size=100%  >&nbsp;<img  style="position: relative;left:0px;top: 4px;" src="../html/images/menu_open.gif" class="Dtoolbutton" onmouseover="this.className='Dtoolbutton';" onmouseout="this.className='Dtoolbutton';" onclick="this.className='Ctoolbutton';commonInputPicker('img', 'document.FM', 'data_Photo')" title="" hspace="0" vspace="0"> </td> </tr> 
			  
			  <tr class='tablelist'> 
              <td align=right  width=70>软件语言:</td>
              <td valign='middle'>
 <input name='data_Language' type='text' value="<?=$pInfo[Language]?>" size=20  > 
					&nbsp; <select name="select" class='flat' onchange="
 ...
 ">
         ...
         <option value="简体中文">简体中文</option>
          ...
          <option value="支持多国语言">支持多国语言</option>
              ...
              <td valign='middle'>
<input name='data_Environment' type='text' value="<?=$pInfo[Environment]?>" size=20  >
			  &nbsp; <select name="select" class='flat' onchange="
         ...
         <option value="win9x/2000/xp">win9x/2000/xp</option>
          ...
          <option value="OS/2">OS/2</option>
           <option value="其他">其他</option>
              ...
              <td valign='middle'><input name='data_SoftKeywords' type='text' value="<?=$pInfo[SoftKeywords]?>" size=50%  > </td> </tr>
			  <tr class='tablelist'> 
              <td align=right  width=70>开 发 商:</td>
              <td valign='middle'><input name='data_Developer' type='text' value="<?=$pInfo[Developer]?>" size=50%  > </td> </tr>
			  			  <tr class='tablelist'> 
              <td align=right  width=70>本地上传:</td>
              <td valign='middle'><input name='data_LocalUpload' type='text' value="<?=$pInfo[LocalUpload]?>" size=100%  >&nbsp;<input name="button5" type='button' tabindex='13' value='...' onclick="InputPicker('upload_attach',this.form,'data_LocalUpload')"> </td> </tr> 
			  

			  <tr>
 <td align=right  width=70>下载地址:</td>
              <td valign='middle'><textarea name='data_Download' class='button' id='Download' style='height:120;width=80%;  background-color:#FFFFFF;' ><?=$pInfo[Download]?></textarea>
			  &nbsp; <img  style="position: relative;left:0px;top: 4px;" src="../html/images/menu_open.gif" class="Dtoolbutton" onmouseover="this.className='Dtoolbutton';" onmouseout="this.className='Dtoolbutton';" onclick="this.className='Ctoolbutton';commonInputPicker('attach', 'document.FM', 'data_Download', 'parent.data_Download_input');" title="" hspace="0" vspace="0">  <br>多个下载地址请使用“回车符”分隔<p></p></td> </tr>


 		   <tr class='tablelist'> 
              <td align=right  width=70> </td>
              <td valign='middle'><script src="ui.php?sId=<?=$IN[sId]?>&o=editor__html.js"></script>	 </td> </tr>

			  <tr class='tablelist'> 
              <td align=right  width=70>软件介绍:</td>
              <td valign='middle'>

 <Iframe name=EditContent      style="width:95%;height:200;border:5;" > 
                </Iframe> <textarea name="SaveContent" id="SaveContent"    style="height:350;display:none;" class='button' id='Content' style='height:200;width=95%;overflow:auto;background-color:#FFFFFF;'>
<?=$pInfo[Intro]?>
			</textarea> 
 <INPUT TYPE="hidden" name="data_Intro_html" id="data_Intro_html">
 </td> </tr>  

<!--			  <tr class='tablelist'> 
              <td align=right  width=70>软件介绍:</td>
              <td valign='middle'><textarea name='data_Intro' class='button' id='Intro' style='height:100;width=80%;background-color:#FFFFFF;' ><?=$pInfo[Intro]?></textarea> </td> </tr> -->
 <tr class='tablelist'> 
              <td align=right  width=80>自定义相关软件:</td>
              <td valign='middle'>
			  
		<table   border=0  cellPadding=2 cellSpacing=0 ><tr><td > <select name='data_CustomSoftLinks' name='select' size='10'>
		<?php
		...
		<td class='line_height'>&nbsp;<input name='button5' type='button' tabindex='13' value='×' style="font:9pt;font-family: Verdana, Arial, Helvetica, sans-serif;"   onclick=del(this.form.data_CustomSoftLinks)><br><br>&nbsp;<input name='button5' type='button' tabindex='13' value='∧' onclick=moveUp(this.form.data_CustomSoftLinks)><br>&nbsp;<input name='button5' type='button' tabindex='13' value='∨' onclick=moveDown(this.form.data_CustomSoftLinks)><br><br>&nbsp;<input name="button5" type='button' tabindex='13' value='...' onclick=editContentLink('CustomSoftLinks')> 
		</td><td>&nbsp;<input name='button5' type='button' tabindex='13' value='&nbsp;Go&nbsp;' onclick=GoSelect(this.form.data_CustomSoftLinks)></td></tr></table>			  
...
<table border="0" cellspacing="0" cellpadding="0" width=80 style="BORDER-LEFT: buttonshadow 1px solid; BORDER-RIGHT: buttonshadow 1px solid; BORDER-TOP: buttonshadow 1px solid; BORDER-BOTTOM: buttonshadow 1px solid;" bgcolor=threedface>
  <tr onClick="parent.doing('insert_flash');" title="插入Flash" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
<td style="cursor: hand; font:8pt tahoma;" height=20> 
  &nbsp;&nbsp;插入Flash&nbsp; </td>
  </tr>
  <tr onClick="parent.doing('insert_video');" title="插入视频" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
<td style="cursor: hand; font:8pt tahoma;" height=20> 
  &nbsp;&nbsp;插入视频&nbsp; </td>
  </tr>
  <tr onClick="parent.doing('insert_music');" title="插入音频" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);"> 
<td style="cursor: hand; font:8pt tahoma;" height=20> 
  &nbsp;&nbsp;插入音频&nbsp; </td>
  </tr>
