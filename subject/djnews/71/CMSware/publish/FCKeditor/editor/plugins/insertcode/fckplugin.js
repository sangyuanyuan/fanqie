锘縁CKCommands.RegisterCommand('InsertCode',new FCKDialogCommand( 'InsertCode', FCKLang["InsertCodeBtn"], FCKPlugins.Items['insertcode'].Path + 'fck_insertcode.html', 550, 420 ) ) ;
...
FCKInsertCode.Add = function( lan,lantxt,txt )
{
	...
	ht.Highlight(txt);
	coText.innerHTML='<div class="codeHead">'+lantxt+'浠ｇ爜</div>'+ht.div.innerHTML;
}
