...
//	$keywords = utf8_explode(' ', utf8_trim(fulltextSeparater($highlightstr)));
	...
	if($length != 0) $content = utf8_subStr($content, $start, $length);
