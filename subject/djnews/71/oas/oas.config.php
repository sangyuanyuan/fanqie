<?php
//CWPS及OAS接口定义
$SYS_ENV['CWPS_URL'] = "172.27.203.81:8080/subject/djnews/71/cwps/";		//CWPS的URL，请勿忘记最后的斜框"/"
$SYS_ENV['OAS_URL']	= "172.27.203.81:8080/subject/djnews/71/oas/";		//OAS的URL，请勿忘记最后的斜框"/"
$SYS_ENV['CookiePre'] = "cmsware_passport_oas_";	//无须更改
$SYS_ENV['OASID']   =  "22";						//CWPS中的OAS管理中定义的用以处理本OAS的OASID
$SYS_ENV['TransactionAccessKey'] = "a6e116616c0449aa44eae366c0c6093f";		//CWPS设置的该OAS的CWPS访问密码
...
//应用程序接口全局定义
$SYS_ENV['passport_key']    =  "a6e116616c0449aa44eae366c0c6093f";	//OAS与应用程序间设置的通行证密码
