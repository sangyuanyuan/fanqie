...
?>		
		<div id=title><div class="cl"><a target="_blank" href="index.php">首页</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $jdls[0]->cid; ?>">经典论述</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php $zxdt[0]->cid; ?>">最新动态</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $ldjh[0]->cid; ?>">领导讲话</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $xxxd[0]->cid; ?>">学习心得</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $xxjb[0]->cid;?>">信息简报</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $ztjz[0]->cid;?>">专题讲座</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $alfx[0]->cid; ?>">案例警示</a></div><div class="cl"><a target="_blank" href="djlist.php?id=<?php echo $mtpl[0]->cid; ?>">媒体评论</a></div><div class="cl"></div><div class="cl"><a target="_blank" href="/djnews/djnews.php">学实活动</a></div></div>
