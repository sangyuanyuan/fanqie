						...
						<div class=bg>
							...
							<div id=content5>
								<?php for($i=0;$i<count($pic);$i++){ ?>
									<div class="pics"><a target="_blank" href="djcontent.php?id=<?php echo $pic[$i]->id; ?>"><img border=0 width=130 height=90 src="<?php echo $pic[$i]->photo_src; ?>"><br><?php echo delhtml($pic[$i]->short_title); ?></a></div>
								<?php } ?>
							</div>
