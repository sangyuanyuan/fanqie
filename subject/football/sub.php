...
<div id=ibody>
	...
	<div id=b>
		...
		<div class=t_r>
			<input type="hidden" name="MAX_FILE_SIZE" value="2097152"><input type="file" name="image" id="image" class="required">(png,jpg,gif)
		</div>
		<div class=l><img src="/images/news/news_sub_icon.jpg">　选择视频</div>
		<div class=t_r>
			<input type="hidden" name="MAX_FILE_SIZE" value="102097152"><input type="file" name="video" id="video" class="required">(flv,wmv,wav,mp3,mp4,avi,rm)
		</div>
	</div>
	<?php }else{
	?>
