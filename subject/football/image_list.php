...
<div id=ibody>
     ...
     <!-- start right !-->
 	 	 <div id=r>
			...
			<div class=content>
				<div class=pic>
					<a href="<?php if($type!='magazine'){echo $link.$records[$i]->id;}else{echo $records[$i]->online_url;}?>" target="_blank" title="<?php echo strip_tags($records[$i]->$l_title);?>"><img src="<?php echo $records[$i]->src ?>" width="140" height="80" border=0></a>
				</div>
