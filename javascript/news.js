	$(document).ready(function(){
		...
		$(".flower").click(function(){
			...
			$.post("/pub/pub.post.php",{'type':'flower','id':$(this).next().attr('value'),'db_table':'smg_digg','digg_type':'comment'},function(data){			
				if(data!=''){
				}
			});
			total('新闻DIGG','news');
		...
		$(".tomato").click(function(){
			...
			$.post("/pub/pub.post.php",{'type':'tomato','id':$(this).next().attr('value'),'db_table':'smg_digg','digg_type':'comment'},function(data){
				if(data!=''){
				}
			});
			total('新闻DIGG','news');
