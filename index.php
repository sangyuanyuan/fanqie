 ...
 <div id=ibody_top>
		...
		<div id=p2>
  		...
  		<?php
			...
			?>
			<div id=t_r_t>
				<div id=left><a target="_blank" href="<?php echo "/".$record_head[0]->platform."/news/news_head.php?id=".$record_head[0]->news_id ?>"><img border=0 src="images/xyy2_logo1.jpg"></a></div>
				<div id=right>
