...
$gb=$db->query('select description,content from smg_news where id=47028');
 ?>
		<div id=p2_top><span style="color:#ff0000;">今日宣传总值班</span>：上视大厦 （日）<?php echo delhtml($ss[0]->description); ?>（夜）<?php echo delhtml($ss[0]->content); ?>　东视大厦 （日）<?php echo delhtml($ds[0]->description); ?>（夜）<?php echo delhtml($ds[0]->content); ?>　广播大厦　<?php echo delhtml($gb[0]->content); ?></div>
		<div id=p2>
 			<!-- start top_right_top !-->
  		<?php
