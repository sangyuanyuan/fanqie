		...
		<div id=p3>
             ...
             <? }?>
 						...
 						<div style="width:138px; height:52px; margin-bottom:5px; padding:3px; text-align:center; border:1px solid #ff0000; float:left; display:inline">
 							<a href="/subject/sxxx/" target=_blank><img src="/images/4.jpg" width="125" border=0></a>
 							<a style="width:120px; height:15px; margin-left:9px; line-height:15px; text-decoration:none; color:#000000; overflow:hidden; float:left; display:inline;" href="<?php echo "/news/news/news_list.php?id=".$record_import_d[0]->cid ?>" target="_blank"><?php echo $record_import_d[0]->short_title; ?></a>
 						</div>
 						<div class=space></div>
  					<ul>
 						 <?php for($i=8; $i<13; $i++){?>
