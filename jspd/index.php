          ...
          <td><table id="__01" width="255" border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="246" border="0" cellspacing="0" cellpadding="0">
                <tr valign="top">
                 ...
                 <marquee height="143" DIRECTION="up" scrollamount="2" onmouseover=this.stop() onmouseout=this.start()>
										<? for($i=0;$i<$count;$i++)
										{
	              				if(strlen($records[$i]->short_title)>30)
	              				{?>
	              				<a target="_blank" href="news.php?id=<? echo $records[$i]->id;?>" target="_blank" class="blue">・<? echo substr($records[$i]->short_title,0,30).'...';?></a>
	              				<?}
	              				else 
	              				{?>
	              					<a target="_blank" href="news.php?id=<? echo $records[$i]->id;?>" target="_blank" class="blue">・<? echo $records[$i]->short_title;?></a>
	              				<?}
	              				?>
	              				</a> <br>
	                  	<?
              ...
              <td height="205" align="center" valign="top" background="images/left_04.jpg"><table width="246" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="green">
                    <? for($i=0;$i<$count;$i++)
                  	{?>
                  		<a target="_blank" href="news.php?id=<? echo $records[$i]->id;?>" target="_blank" class="blue">・ 
                  		<? 
                  			if(strlen($records[$i]->short_title)>30)
	              				{
	              					echo substr($records[$i]->short_title,0,30).'...';
	              				}
	              				else 
	              				{
            ...
            <tr>
              <td height="41" background="images/left_08.jpg"><table width="226" height="18" border="0" cellpadding="0" cellspacing="0">
                ...
                ?>
                  <td width="31" height="18">&nbsp;</td>
                    <td width="195" valign="bottom" class="m-t"><div style="float:left; display:inline;">我要投票</div><div style="float:right; display:inline"><a target="_blank" style="color:#ffffff; text-decoration:none;" href="tick.php">更多</a></div></td>
                  </tr>
                </table></td>
              </tr>
            <tr>
              ...
              <td height="165" align="center" background="images/left_11.jpg"><table width="246" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top" class="gry"> 	
                  	<?php
                  		for($i=0;$i<$count;$i++){?>
                  			<a target="_blank" href="<? echo $records[$i]->link;?>" target="_blank" class="gry">・ 
                  				<?php
                  				if(strlen($records[$i]->name)>30)
		              				{
		              					echo substr($records[$i]->name,0,30).'...';
		              				}
		              				else 
		              				{
		              					echo $records[$i]->name;
            ...
            <table id="__01" width="418" height="1077" border="0" cellpadding="0" cellspacing="0">
              ...
              ?>
                <td>
                	<script src="/flash/sohuflash_1.js" type="text/javascript"></script>
						...
						var picflash = new sohuFlash("/flash/focus.swf", "focus_01", "415", "180", "6","#FFFFFF");
						picflash.addParam('wmode','opaque');
						picflash.addVariable("picurl",pics);
						picflash.addVariable("piclink",mylinks);				
						picflash.addVariable("pictime","5");
						picflash.addVariable("borderwidth","415");
              ...
              <tr>
                <td height="170" align="center" background="images/med_03.jpg">
                	<table width="405" border="0" cellspacing="0" cellpadding="0">
	                  <tr>        						
	                    <td class="gre-nr">
	                    	<div class="mltt hide" style="display:block;">
	                    		<? for($i=0;$i<$count1;$i++){?>
		                    		<a target="_blank" href="news.php?id=<?php echo $records1[$i]->id;?>" class="gre-nr">・ 
			                    		<? 
				                    		if(strlen($records1[$i]->short_title)>30)
					              				{
					              					echo substr($records1[$i]->short_title,0,30).'...';
					              				}
					              				else 
					              				{
			                    		...
			                    		?>
			                    	</a>  <span class="grr"> <? echo $records[$i]->created_at;?></span> <br>
	                    		<? }?>
	                    	</div>	                     
	                     	<div class="zdgz hide" style="display:none;">
		                    		<? for($i=0;$i<$count2;$i++){?>
			                    		<a target="_blank" href="news.php?id=<?php echo $records2[$i]->id;?>" class="gre-nr">・ 
				                    		<? 
					                    		if(strlen($records2[$i]->short_title)>30)
						              				{
						              					echo substr($records2[$i]->short_title,0,30).'...';
						              				}
						              				else 
						              				{
				                    		...
				                    		?>
				                    	</a>  <span class="grr"> <? echo $newszd->items[$i]->created_at;?></span> <br>
		                    		<? }?>
	                    		</div>
	                    	</td>
              ...
              <tr>
                <td>
                	<div class="mltt" style="display:block;">
                	...
                	<div class="zdgz" style="display:none;">
                  ...
                  <tr>
                    <td class="gre-nr">
                    		<?php for($i=0;$i<$count;$i++){?>
	                    		<a target="_blank" href="news.php?id=<? echo $records[$i]->id;?>" class="gre-nr">・ 
	                    			<?php
			              					echo $records[$i]->short_title;
	                    			?>
              ...
              <tr>
                <td height="167" align="center" valign="top" background="images/med_09.jpg"><table width="405" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="gre-nr">
                    	<? for($i=0;$i<$count;$i++){?>
	                    		<a target="_blank" href="news.php?id=<?php echo $records[$i]->id;?>" class="gre-nr">・ 
	                    			<?php 
	                    			if(strlen($records[$i]->short_title)>30)
			              				{
			              					echo substr($records[$i]->short_title,0,30).'...';
              ...
              <tr>
                <td><a target="_blank" href="newslist?id=<?php echo dept_category_id_by_name('现磨咖啡','纪实频道','news');?>"><img src="images/med_10.jpg" alt="" width="418" height="31" border="0" ></a></td>
              </tr>
              <tr>
                  ...
                  <tr>        
                 		<td colspan="3">
                 			<marquee height="133" onmouseover=this.stop() onmouseout=this.start() >
                 				<? for($i=0;$i<$count;$i++){?>         					
                 					<a target="_blank" href="/photo/showphoto.php?id=<? echo $records[$i]->id;?>"><img border="0" src="<? echo $records[$i]->src;?>" width="125" height="100"></a>
                 				<? }?>
                 			</marquee>
                 		</td>	
                  </table></td>
              ...
              <tr>
                <td height="31" background="images/rig_01.jpg"><table width="253" height="19" border="0" cellpadding="0" cellspacing="0">
				  ...
				  ?>
                    ...
                    <td width="216" valign="bottom" class="m-t"><div style="float:left; display:inline;">好好学习</div><div style="float:right; display:inline"><a target="_blank" style="color:#ffffff; text-decoration:none;" href="video.php?id=<?php $records[0]->id;?>">更多</a></div></td>
                  </tr>
                  </table></td>
              </tr>
              <tr>
                <td width="271" height="340" align="center" valign="top" background="images/rig_02.jpg"><table width="251" height="92" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="251" height="150" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                    <?php
						$records = show_content('smg_news','news','纪实频道','私房推荐','1');
						$count = count($records);
					?>
                    ...
                    <tr>
                      <td height="18" colspan="2" class="nr-d"><? for($i=1;$i<4;$i++){?>
                      	<? 
                      	if(strlen($records[$i]->title)>30)
		              				{?>
		              					<a target="_blank" href="news.php?id=<? echo $records[$i]->id;?>" class="nr-d">・<? echo substr($records[$i]->title,0,30).'...';?></a>
		              				<?}
		              				else 
		              				{?>
		              					<a target="_blank" href="news.php?id=<? echo $records[$i]->id;?>" class="nr-d">・<? echo $records[$i]->title;?></a>
		              				<?}
                      	?></a><br><? }?></td>
                    </tr>
                  </table>
              ...
              <tr>
                <td height="250" align="center" valign="top" background="images/rig_08.jpg"><table width="251" height="92" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="114" rowspan="2" align="center"><img src="<? echo $newslist1->items[0]->photourl;?>" width="80" height="80"></td>
                  </tr>
                  <tr>
                    <td class="nr-d"><a target="_blank" href="news.php?id=<? echo $newslist1->items[0]->id;?>" class="whi"><? echo $newslist1->items[0]->title;?></a></td>
                  </tr>
                  <tr>
                    <td height="18" colspan="2" class="nr-d"><img src="images/line.jpg" width="251" height="14"></td>
                  </tr>
                  ...
                  <table width="251" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="whi">
                      	<? for($i=1;$i<4;$i++){?>
		              					<a target="_blank"  style="color:#ffffff; text-decoration:none;" href="news.php?id=<? echo $newslist1->items[$i]->id;?>">・<? echo $newslist1->items[$i]->title;?></a><br><? }?>
		              		<? for($i=0;$i<4;$i++){?>
		              					<a target="_blank"  style="color:#ffffff; text-decoration:none;" href="news.php?id=<? echo $newslist1->items[$i]->id;?>">・<? echo $newslist1->items[$i]->title;?></a><br><? }?>			
		              		</td>
                  </tr>
