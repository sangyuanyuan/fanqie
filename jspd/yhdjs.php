                ...
                <td width="680" align="center" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="47%" rowspan="4" valign="top">
                    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="38" background="images/tt-bg.jpg" class="wz"><strong>领导活动：</strong></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      <DIV id="content2">
                        ...
                        <span class="wz">
                        <TEXTAREA name="content" cols="40" rows="6" id="lettercontent"></TEXTAREA>
                        </span></DIV>
                      <DIV>
                        <span class="wz">
                        <BUTTON onClick="PostDeptComment('lettertitle','writer','lettercontent','','','')">提交</BUTTON>
                        </span></DIV>
                      <INPUT type="hidden" value="writeletter" name="submittype"></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                    </tr>
...
{
	document.getElementById('lettercontent').value='对 '+leader+'说：'+ document.getElementById('lettercontent').value;
}
</script>