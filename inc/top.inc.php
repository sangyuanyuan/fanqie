...
<div id=nav1>
	...
	<?php $xsb=$db->query('select target_url from smg_news n left join smg_category c on n.category_id=c.id where c.name="星尚榜" order by n.priority asc,n.created_at desc limit 1'); ?>
		<div id=context><a target="_blank" href="<?php echo $xsb[0]->target_url; ?>" target="_blank" style="color:#ff0000;font-weight:bold">星尚榜</a>　　<a href="/zone/" target="_blank" style="color:#ff0000;font-weight:bold">番茄个性版</a>　　<a href="http://172.27.203.88/emailfront/emailfront.htm" target="_blank">企业邮箱</a> <a href="#">新节目</a> <a href="#">直播</a> <a href="/contact/contact.php" target="_blank">联系我们</a> <span onclick="javascript:document.getElementById('toolcontent').style.display='inline'">常用办公软件</span></div>		
