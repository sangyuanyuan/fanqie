...
<div id=nimg1>
	...
	<a target="_blank" href="/subject/Lantern/"><img border=0 src="/images/yx.gif"></a>
	...
	<div id=box>
	  ...
	  <div id=search>
	  	<form id="top_search_form" method="get" action="/search/">
   		...
   		<div id=hot>
   			<?php //for($i=0;$i<1;$i++){?>
   				<a href="http://qjdls.smgbb.cn" target=_blank><img style="margin-top:0px;" width=50 height=20 border=0 src="/images/qj.gif"></a>
