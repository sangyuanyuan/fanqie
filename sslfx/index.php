...
<body>
	...
	<div id=ibody>
		<div id=ibody_left>
			...
			<div class=l_content>
				...
				<div style="width:395px; height:395px; float:left; display:inline;" id="raderimg"><img src="/pChart/example8.jpg"></div>
			</div>
	...
	$name=$db->query($sql);?>
				...
				<div style="width:970px; height:350px;" id="imagefoldline"><?php $foldline=$db->query("select file_path from smg_ratings where imgtype='foldline' order by id desc limit 1"); ?><img src="<?php echo $foldline[0]->file_path; ?>"></div>
