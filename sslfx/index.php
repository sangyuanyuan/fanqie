...
<body>
	...
	<div id=ibody>
		...
		<div id=ibody_right>
			...
			<?php $sql="select n.title,n.id,c.id as cid from smg_news n left join smg_category c on n.category_id=c.id where c.category_type='news' and c.name='收视率相关文献' and n.is_adopt=1 order by n.priority asc, n.created_at desc limit 2";
				$news=$db->query($sql);
			?>
