	...
	<div id=ibody_left>
		<div id=l_b>
			<div style="margin-top:10px; margin-left:10px; float:left; display:inline;">
				<?php $sql="SELECT * FROM smg_report_item s";
					$item=$db->query($sql);
				?>
				频道或节目：<select id="reportitem">
				...
				类型：<select id="type">
						...
						<option value="foldincome" <?php if($_REQUEST['type']=="foldincome"){?>selected=selected<?php } ?>>柱形图</option>
				</select>
