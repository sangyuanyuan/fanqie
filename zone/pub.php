<?php
	function echo_dialog_question($item,$index,$dialog_id){
		...
		echo ' <a href="comment_question.php?height=550&width=670&question_id='.$item->id .'" title="评论问题" class="comment_href">评论</a>';
	...
	function echo_dialog_comment($item){
		echo "<div class=\"comment_list_item\"><span class=\"comment_list_writer\">{$item->nick_name}:</span><span class=\"comment_list_content\">{$item->comment}</span><div class=\"comment_list_time\">{$item->created_at}</div></div>";
	}
