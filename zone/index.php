...
<head>
	...
	<? 	
		...
		$db=get_db();
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='HOT讨论区' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 1";
		$tlqimg=$db->query($sql);	
		$sql="select n.id,n.short_title,n.title,n.platform,n.description from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='讨论区' and c.category_type='news' order by n.priority asc,n.created_at desc limit 11";
		$record=$db->query($sql);	
		$sql="select n.id,n.short_title,n.title,n.platform,n.description from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='上班这点事' and c.category_type='news' order by n.priority asc,n.id desc limit 12";
		$sbzds=$db->query($sql);	
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='上班这点事' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 2";
		$sbzdsimg=$db->query($sql);
		$sql="select n.id,n.short_title,n.title,n.platform,n.description from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='生活大杂烩' and c.category_type='news' order by n.priority asc,n.created_at desc limit 12";
		$shdzh=$db->query($sql);
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='生活大杂烩' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 2";
		$shdzhimg=$db->query($sql);
		$sql="select n.id,n.short_title,n.title,n.platform,n.description,c.id as cid from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='观点视角' and c.category_type='news' order by n.priority asc,n.created_at desc limit 8";
		$gdsj=$db->query($sql);
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='观点视角' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 1";
		$gdsjimg=$db->query($sql);
		$sql="select n.id,n.short_title,n.title,n.platform,n.description,c.id as cid from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='分享生活' and c.category_type='news' order by n.priority asc,n.created_at desc limit 11";
		$fxsh=$db->query($sql);
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='分享生活' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 1";
		$fxshimg=$db->query($sql);
		$sql="select n.description from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='交流公告' and c.category_type='news' order by n.priority asc,n.created_at desc limit 1";
		$gg=$db->query($sql);
		...
		$blog=$db->query($sql);
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='劲爆热图' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 6";
		$jbrt=$db->query($sql);
		...
		$sql="select n.id,n.short_title,n.title,n.platform,n.description from smg_news n left join smg_category c on n.category_id=c.id and n.is_adopt=1 and c.name='博主真人秀' and c.category_type='news' order by n.priority asc,n.created_at desc limit 1";
		$blogsure=$db->query($sql);
		$sql="select src,url,title from smg_images i left join smg_category c on i.category_id=c.id and i.is_adopt=1 and c.name='博主真人秀' and c.category_type='picture' order by i.priority asc,i.created_at desc limit 1";
