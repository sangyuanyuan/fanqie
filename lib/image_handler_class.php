...
class image_handler_class
{
     ...
     */
    function load($src_img, $img_type=null)
    {
	...
	function resize_image($img_name,$p1,$p2=null) {
		$this->set_dest($img_name);
		return $this->createImg($p1,$p2);
	}
