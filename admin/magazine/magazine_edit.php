...
<body style="background:#E1F0F7">
	...
	<table width="795" border="0">
		...
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
			<td>在线杂志</td><td align="left">　<input type="text" size="50" name="magazine[online_url]" value="<?php echo $magazine_record[0]->online_url;?>">（如果本地上传电子杂志此项请留空！）</td>
		</tr>
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
		...
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
			<td>选择杂志</td><td align="left">　 <input type="hidden" name="MAX_FILE_SIZE" value="5000000"> <input name="magazine" id="magazine" type="file" >(请上传电子杂志，并且不要大于50M)</td>
		</tr>
