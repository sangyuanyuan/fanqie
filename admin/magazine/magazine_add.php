...
<body style="background:#E1F0F7">
	...
	<table width="795" border="0">
		...
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
			<td>选择电子杂志</td><td align="left">　 <input type="hidden" name="MAX_FILE_SIZE" value="50000000"> <input name="magazine" id="magazine" type="file" class="required">(请上传视频，并且不要大于50M)</td>
		</tr>
