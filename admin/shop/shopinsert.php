...
<body style="background:#E1F0F7">
	...
	<table width="795" border="0">
		...
		<tr align="center" bgcolor="#f9f9f9" height="150px;" id=newsshow1 style="font-size:12px">
			<td>内　容</td><td align="left">　<input type="hidden" id="content" name="shop[content]" value="" style="display:none" /><input type="hidden" id="content___Config" value="" style="display:none" /><iframe id="content___Frame" src="../../FCKeditor/editor/fckeditor.html?InstanceName=content&amp;Toolbar=Default" width="98%" height="280" frameborder="0" scrolling="no"></iframe></td>
		</tr>
