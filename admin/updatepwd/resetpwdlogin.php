...
<form name="login" id="login" action="checklogin.php" method="post" style="width:100%; height:550px;background:url(/images/bg/admin_bg1.jpg) repeat-x;margin-top:0px;">
<body>
	<div id=main>
		<div id=login  style="background:none">
			<div id=title>重置密码管理员登录    </div>
			...
			<div id=box style="border:1px solid #0066FF">
				...
				<div id=btn><input type="checkbox" id=nickname >　　<a href="register.php" style="color:#000000; text-decoration:none"></a>　　<input type="submit" value="登录" class="botton"></div>	
