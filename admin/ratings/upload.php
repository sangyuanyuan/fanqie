...
<body>
	...
	<form id="category_form" enctype="multipart/form-data" method="post" action="upload.post.php">
		<tr class=tr3>
			<td>选择日期：</td>
			<td align="left"><input type="text" class="date_jquery required" name="date"></td>
		</tr>
		<tr class=tr3>
			<td>上传文件：</td>
