...
<body style="background:#E1F0F7">
	...
	<table width="795" border="0">
		...
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
			<td>选择图片</td><td align="left">　<input name="image" id="image" type="file" class="required">(请上传200x160大小的图片，格式支持jpg、gif、png) <input type="hidden" name="MAX_FILE_SIZE1" value="2097152"></td>
		</tr>
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
			<td>选择视频</td><td align="left">　<input name="video" id="video" type="file" class="required">(请上传视频，并且不要大于500M) <input type="hidden" name="MAX_FILE_SIZE1" value="2097152"></td>
		</tr>
