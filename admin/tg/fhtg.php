<?php
	...
	{
		$records = $question->paginate('all',array('order'=> 'created_at desc'),18);	
	}
	$count = count($records);
?>
...
<body style="background:#E1F0F7">
	<table width="795" border="0">
		<tr class="tr1">
			<td colspan="4" width="795">　　　<a href="fhtg_add.php" style="color:#0000FF">发布复合团购</a>
		...
		<tr class="tr3">
			...
			<input type="hidden" id="db_talbe" value="smg_fhtg">
		</tr>
	</table>
	<div class="div_box">
		<table width="795" border="0">
