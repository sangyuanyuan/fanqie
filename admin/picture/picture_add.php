...
<body style="background:#E1F0F7">
	...
	<table width="795" border="0">
		...
		<tr align="center" bgcolor="#f9f9f9" height="25px;" id=newsshow3 >
			<td>选择图片</td><td align="left">　<input type="hidden" name="MAX_FILE_SIZE1" value="2097152"><input name="image" id="image" type="file" class="required">(请上传200x160大小的图片，格式支持jpg、gif、png) </td>
		</tr>
