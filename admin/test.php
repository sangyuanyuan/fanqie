<?php
	...
	$count  = count($record);
	for($i=0;$i<$count;$i++){
		$sql = 'update smg_link set category_id='.$record[$i]->ord_id.' where category_id='.$record[$i]->id;
		$db->execute($sql);
	}
	...
	$count  = count($record);
	for($i=0;$i<$count;$i++){
		$sql = 'update smg_news set dept_category_id='.$record[$i]->ord_id.' where dept_category_id='.$record[$i]->id;
		$db->execute($sql);
	}
	...
	$count  = count($record);
	for($i=0;$i<$count;$i++){
		$sql = 'update smg_images set dept_category_id='.$record[$i]->ord_id.' where dept_category_id='.$record[$i]->id;
		$db->execute($sql);
	}
	...
	$count  = count($record);
	for($i=0;$i<$count;$i++){
		$sql = 'update smg_video set dept_category_id='.$record[$i]->ord_id.' where dept_category_id='.$record[$i]->id;
		$db->execute($sql);
	}
	...
	$count  = count($record);
	for($i=0;$i<$count;$i++){
		$sql = 'update smg_vote set dept_category_id='.$record[$i]->ord_id.' where dept_category_id='.$record[$i]->id;
		$db->execute($sql);
	}
