<?php
	...
	$category_menu = $category->find("all",array('conditions' => "category_type='vote' and dept_id={$_COOKIE['smg_user_dept']}","order" => "priority"));
...
<form id="vote_form" method="post" enctype="multipart/form-data" action="vote.post.php">
 <table width="795" border="0" id="list">
		...
		<tr class=tr3>
			...
			<td align="left"  class="newsselect">
				<select  name="vote[dept_category_id]">
 ...
 <table width="795" border="0" id="list">
		...
		<input type="hidden" name="vote[dept_id]" value="<?php echo $_COOKIE['smg_user_dept'];?>">
		<input type="hidden" name="vote[category_id]" value="0">
		<input type="hidden" name="vote[is_adopt]" value="0">
		<input type="hidden" name='is_app' value="2">
 </table>
 </form>
