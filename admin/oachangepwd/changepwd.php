...
<div id=main>
	...
	<div id=name style="margin-top:15px;" >工　　号：　<input type="text" id="userid" name="updatepwd[userid]" style="width:140px; height:17px; border:0px; background:#CBEBFA;" value="<?php echo $_REQUEST['usercode']; ?>" readonly="true"></div>
   ...
   <input type="hidden" id="subtype" name="subtype" value="updatepwd">
	<div id=zhu>工作在线的工号和密码与登录机器的帐号和密码以及番茄网的帐号与密码相同，若改动，将同时改动番茄网和登录机器的帐号与密码</div>
	</div>
