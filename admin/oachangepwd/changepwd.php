...
<div id=main>
	...
	<div id=name style="margin-top:15px;" >工　　号：　<input type="text" id="userid" name="updatepwd[userid]" style="width:140px; height:17px; border:0px;" value="<?php echo $_REQUEST['usercode']; ?>" readonly="true"></div>
