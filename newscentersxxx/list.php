...
<div id="content">
  <div id="bodybg">
  	<?php $sql="select n.id,n.title,n.created_at,d.name,n.short_title from smg_news n left join smg_category_dept d on n.dept_category_id=d.id where d.id=".$_REQUEST['id']." order by n.priority asc,created_at desc";
  		$db=get_db(); 
