...
<body>
	...
	<div id=answer>
		<div id=left>
			<div style="width:980px; font-size:20px; color:red; text-align:center; margin-top:10px; margin-left:15px; line-height:22px; float:left; display:inline;"><?php echo delhtml($vote->name);?></div>
