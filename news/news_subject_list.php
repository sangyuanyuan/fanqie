...
<head>
	...
	<? 	
		...
		$db = get_db();
		$sql="select n.title,n.platform,n.id,n.created_at,n.category_id,c.category_id as cid from smg_news n inner join smg_subject_items c on n.category_id=c.resource_id where n.is_adopt=1 and c.category_id=".$id." order by n.priority asc,n.created_at desc";
