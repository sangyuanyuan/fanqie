...
<head>
	...
	<? 	
		...
		$news4=$db->query($sql);
		$sql="select * from smg_news where category_id in (".$news1[0]->cid.",".$news2[0]->cid.",".$news3[0]->cid.",".$news4[0]->cid.") and is_adopt=1 and created_at >='2010-07-01 00:00:00' order by priority asc, created_at desc";
