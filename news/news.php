  ...
  当前第<select name="pageselect" id="pageselect" onChange="jumppage('<?php echo $string."&page="; ?>',this.options[this.options.selectedIndex].value);">
	...
	<div id=ibody_right>
		<div id=r_t>
			...
			<embed src="<?php echo $bbtv[0]->filename; ?>" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="298" height="88"></embed>
